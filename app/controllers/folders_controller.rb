class FoldersController < ApplicationController
  ...
  def new
    ...
    #if there is a "folder_id" param, we know that we are under a folder, thus, we will essentialy create a subfolder
  ...
  def destroy
    ...
    #sub folders will also be deleted as well as the files within
    @folder.destroy
    flash[:notice] = "Successfully destroyed folder and all the contents inside."
